...
function ToastItem({ toast, onRemove }: { toast: Toast; onRemove: (id: string) => void }) {
  const getToastStyles = (type: Toast['type']) => {
    switch (type) {
      ...
      case 'warning':
        return 'bg-yellow-500 text-black border-l-4 border-yellow-400';
      case 'info':
  ...
  return (
    <div
      className={`w-full shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5 transform transition-all duration-300 ease-in-out animate-in slide-in-from-right-full ${getToastStyles(toast.type)}`}
    >
      <div className="flex-1 p-4 min-w-0">
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-shrink-0 flex">
            <button
              className="rounded-md inline-flex text-white hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-white transition-colors"
